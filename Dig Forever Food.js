//My custom item
ModPE.setFoodItem(511,"pickaxe",1,0,"Eat Me");

//Paste all the below in your code
var nowAmount;
var nowId;
var nowData;
var lastAmount;
...
var foodItems = [260,282,297,319,320,349,350,357,360,363,364,365,366,367,391,392,393,400,/*My custom id ->*/511];
...
function useItem(x,y,z,itemId,blockId){
	...
	if(invBlocks.indexOf(lastBlock)>=0){ //if the block is in invBlocks
...
function newLevel(){
	Player.addItemInventory(511,64,0);
	clientMessage("Welcome to my eatHook Example\nNow jump off a cliff and eat my pickaxe :3");
}

function eatHook(foodId){
	//now you can do if statements and ooh, do a switch :3
	if(foodId==511){ //if you eat an apple
		Entity.addEffect(Player.getEntity(), MobEffect.digSpeed, 9999*20, 2, false, true);
	}
}
