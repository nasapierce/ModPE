...
var stoneBlocks = [22,41,42,44,43,45,49,57,61,67,101,108,109,112,114,121,128,133,139,156,172,173,245,247];
//texture vars
var p = "planks";
var d = "stone_slab";
var b = [
...
function startDestroyBlock(x, y, z, side){
	...
	if(block == 181 || block == 182 || block == 186)
		ModPE.showTipMessage("Make sure you empty the barrel first /n or the liquid will be lost!");
}
...
function reward(x, y, z, outputId, outputData){
	var tmp = Level.dropItem(x + 0.5, y + 1.5, z + 0.5, 0, outputId, 1, outputData);
...
function modTick(){
/*
if(Entity.getMobSkin(Player.getPointedEntity())=="cow.png"){
