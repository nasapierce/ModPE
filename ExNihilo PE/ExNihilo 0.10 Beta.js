/*Ex Nihilo PE v4.1c for Mcpe v0.9.5 optimized for BlockLauncher 1.7.9
...
Changes in 4.1c:
Darkserver:
-Fixed Netherrack Breaking
-Added Furnace Desc. for furnace items
...
Block.defineBlock(195,"fired_crucible",fcr,4);
...
Block.defineBlock(199,"barrel",b,5,true,0); 
Block.defineBlock(200,"water_barrel",wb,5,true,7); 
Block.defineBlock(201,"stone_barrel",sb,1);
...
Block.defineBlock(204,"witch_barrel",wwb,5,true,0); 
...
function destroyBlock(x, y, z, side){
	...
	if(block == 199 || block == 200 || block == 204 || block == 201){
		preventDefault();
		Level.destroyBlock(x, y, z, false);
		if(dat == 0){
