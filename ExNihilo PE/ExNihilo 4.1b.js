/*Ex Nihilo PE v4.1b for Mcpe v0.9.5 optimized for BlockLauncher 1.7.9
...
sieve wood flavors, better sieve texture, 
fix netherrack dropping bug, fix crucible bug, 
make barrels function like pc, make sieve function like pc, 
make crucible function like pc, add dolls, 
barrels make slime, make witch water flowable, 
guide(GUI)

Future Changes:
Change sieving reward as stated here: http://ex-nihilo-minecraft.wikia.com/wiki/Sieved_Items
...
Changes in 4.1b:
	...
	Dropped dirt from barrel now drops at top center of barrel
...
var stoneBlocks = [22,41,42,44,45,49,57,61,67,87,101,108,109,112,114,121,128,133,139,156,172,173,245,247];
//texture vars
var p = "planks";
var d = "stone_slab";
var b = [
...
function destroyBlock(x, y, z, side){
	...
	if(hammer.indexOf(item) >= 0){
		...
		if(stoneBlocks.indexOf(block) >= 0)
			...
			Level.dropItem(x + .5, y + .5, z + .5, 0, 198, 1, 0);
		}
		else if(block == 196)
