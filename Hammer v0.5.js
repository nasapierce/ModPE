...
Item.addShapedRecipe(390,1,0,["iri","dpd","iri"],["i",42,0,"r",331,0,"d",264,0,"p",278,0]);
//Item.addCraftRecipe(390,1,0,[278,1,0,264,2,0,42,4,0]);

var stone = [1,2,3,4,5,6,12,13,14,15,16,17,19,21,22,24,41,42,43,44,45,48,49,56,57,67,73,74,87,89,98,101,108,109,112,114,128,139,155,156,173,247,33,34,152,153,174,175,176,177,178,179,188,190,191,192,193,194,195,196,197,198,199];
...
function fastDestroy() {
 for(var i = 0; i < 256; i++) {
  var S = 0.07;
  var BT = defaultDestroyTime[i]*1.5;
  var NT = BT*S;
  Block.setDestroyTime(i, NT);
 }
