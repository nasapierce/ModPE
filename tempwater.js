...
//all you have to do is change what temp and waterAmount are
var waterAmount = 0;
var temp = 0;
...
TT.init = function(){
	ctx.runOnUiThread(new java.lang.Runnable({ run: function(){
		try{
			...
			temperature = new android.widget.TextView(ctx);
			temperature.setTextSize(16);
			temperature.setText('Temperature: '+temp);
			temperature.setGravity(android.view.Gravity.LEFT);
			temperature.setTypeface(MinecraftButtonLibrary.ProcessedResources.font);
			temperature.setTextColor(android.graphics.Color.parseColor("#ffff8300"));
			tempThirstLayout.addView(temperature);
			
			water = new android.widget.TextView(ctx);
			water.setTextSize(16);
			water.setText('Water: '+waterAmount);
			water.setGravity(android.view.Gravity.LEFT);
			water.setTypeface(MinecraftButtonLibrary.ProcessedResources.font);
			water.setTextColor(android.graphics.Color.BLUE);
			tempThirstLayout.addView(water);
