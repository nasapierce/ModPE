// a file I made to help with autocomplete with some IDEs
...
Item.getMaxStackSize = function(par1int){return;};
...
Item.internalNameToId = function(par1String){return;};
...
Item.translatedNameToId = function(par1String){return;};
...
Renderer.createHumanoidRenderer.renderType;
Renderer.createHumanoidRenderer.getModel = function(){};
Renderer.createHumanoidRenderer.getModel.getPart = function(part){};
Renderer.createHumanoidRenderer.getModel.getPart.clear = function(){};
Renderer.createHumanoidRenderer.getModel.getPart.addBox = function(x, y, z, width, height, depth, scale){};
Renderer.createHumanoidRenderer.getModel.getPart.setTextureOffset = function(u, v){};
Renderer.createHumanoidRenderer.getModel.getPart.setTextureSize = function(width, height){};
Renderer.createHumanoidRenderer.getModel.getPart.setRotationPoint = function(x, y, z){};
